...
import AdvanceFilterModal1 from '@/components/common/advance-filter-two/AdvanceFilterModal1'
import TopFilterBar1 from './TopFilterBar1'
import FeaturedListingPropertiesType from './featuredListings/FeaturedListingPropertiesType'
import Pagination from '../../Pagination'
import PaginationTwo from "../../PaginationTwo";


export default function ProperteyFiltering1(props) {
        ...
        <div className="container">
          ...
          <div className="advance-feature-modal">
            <div
              ...
              aria-hidden="true"
            >
              <AdvanceFilterModal1 filterFunctions={filterFunctions}  propertyTypes={propertyTypes0} propertyFeatures={propertyFeatures} propertyCities={propertyCities}/>
            </div>
          </div>
          {/* <!-- Advance Feature Modal End --> */}

          <div className="row">
            <TopFilterBar1 pageContentTrac={pageContentTrac}  colstyle ={colstyle} setColstyle={setColstyle}  filterFunctions={filterFunctions} setCurrentSortingOption={setCurrentSortingOption} properties={ listings } propertyTypes0={ propertyTypes0 } propertyFeatures={ propertyFeatures } />
          </div>
          {/* End TopFilterBar */}
