...
const FilterContent = ({propertyTypes, propertyCities}) => {
  ...
  const [price, setPrice] = useState({ value: { min: 0, max: 3000000 } });
              ...
              <div className="row align-items-center">
                    ...
                    <form className="form-search position-relative">
                      <div className="box-search">
                        <input
                          ...
                          type="text"
                          name="search"
                          placeholder={`Entrez le mot-clé pour ${tab.label}`}
                        />
                      </div>
                    </form>
                  </div>
                ...
                <div className="col-md-4 col-xl-2 bdrr1 bdrrn-sm px20 pl15-sm">
                  <div className="mt-3 mt-md-0 px-0">
                    <div className="bootselect-multiselect">
                      <label className="fz14">Type</label>
                      <LookingFor propertyTypes={propertyTypes}/>
                    </div>
                  </div>
                </div>
                {/* End col-md-4 */}
                ...
                <div className="col-md-4 col-xl-2 bdrr1 bdrrn-sm px20 pl15-sm">
                  <div className="mt-3 mt-md-0">
                    <div className="bootselect-multiselect">
                      <label className="fz14">Commune</label>
                      <Location propertyCities={propertyCities}/>
                    </div>
                  </div>
                </div>
                {/* End col-md-4 */}
                ...
                <div className="col-md-4 col-xl-2 bdrr1 bdrrn-sm px20 pl15-sm">
                  <div className="mt-3 mt-md-0">
                    <div className="dropdown-lists">
                      <label className="fz14 mb-1">Prix</label>
                      <div
                        ...
                        style={{ fontSize: "13px" }}
                      >
                        {price.value.min} FCFA - {price.value.max}{" "} FCFA
                        ...
                        <div className="widget-wrapper pb20 mb0 pl20 pr20">
                          <div className="range-wrapper at-home10">
                            ...
                            <div className="d-flex align-items-center">
                              <span id="slider-range-value1" style={{ fontSize: 12 }}>
                                {price.value.min} FCFA
                              </span>
                              <i className="fa-sharp fa-solid fa-minus mx-2 dark-color icon" />
                              <span id="slider-range-value2" style={{ fontSize: 12 }}>
                                {price.value.max} FCFA
                              </span>
                            </div>
                          </div>
                        </div>
