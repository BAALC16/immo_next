...
const TopFilter = ({filterFunctions, propertyTypes0, propertyCities}) => {

    const propertyTypes = [
        
    ];

    propertyTypes0.forEach(element => {
        let label = element.name;
        propertyTypes.push({label: label});    
    });
          ...
          <div className="d-sm-flex">
            <div className="position-relative mb10 mr10">
              <input
                ...
                placeholder="Entrer un nom d'agent"
            ...
            <div className="position-relative mb10 mr10">
              ...
              >
                Types de propriété <i className="fa fa-angle-down ms-2" />
              </button>
            ...
            <div className="position-relative mb10">
              <button
                ...
                data-bs-auto-close="outside"
              >
                Toutes les communes <i className="fa fa-angle-down ms-2" />
              </button>
              <div className="dropdown-menu">
                <div className="widget-wrapper bdrb1 pb25 mb0 p20">
                  <div className="bootselect-multiselect">
                    <Location filterFunctions={filterFunctions} propertyCities={propertyCities}/>
                  </div>
                </div>
                {/* <div className="text-end mt10 pr10">
                  <button
      ...
      <div className="col-md-3">
        <div className="page_control_shorting text-start text-md-end mb20">
          <div className="pcs_dropdown d-flex align-items-center justify-content-end">
            <span style={{ minWidth: "50px", textAlign: "left" }}>Trier par </span>
            <select
              style={{ width: "135px" }}
              className="selectpicker form-select"
            >
              <option>Nouvel agent</option>
              <option>Ancien agent</option>
              <option>Meilleur agent</option>
            </select>
          </div>
        </div>
      </div>
