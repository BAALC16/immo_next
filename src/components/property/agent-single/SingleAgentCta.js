...
const SingleAgentCta = ({agent}) => {
  ...
  const agentData = {
    ...
    social: [
      { icon: "fab fa-facebook-f", link: agent.facebook },
      { icon: "fab fa-twitter", link: agent.twitter },
      { icon: "fab fa-instagram", link: agent.instagram },
      { icon: "fab fa-linkedin-in", link: agent.linkedin },
    ],
  };
  return (
    <>
      <div className="agent-single d-sm-flex align-items-center">
        ...
        <div className="single-contant ml30 ml0-xs">
          ...
          <p className="fz15">
            Company Agent à <b>{agentData.company}</b>
          </p>
